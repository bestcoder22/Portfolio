...
import Codeforces from "../assets/color-codeforces.svg"
import Leetcode from "../assets/color-leetcode.svg"
import AOS from "aos";
...
const socialLinks = [
  {
    ...
    subText: "Soham Amrutkar",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/soham-amrutkar/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "bestcoder22",
    icon: Github,
    url: "https://github.com/bestcoder22",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://codeforces.com/profile/amrutkarsoham22",
    color: "#1f8acb",
  gradient: "from-[#f5c24c] via-[#1f8acb] to-[#f07f23]"
  },
  {
    name: "Leetcode",
    ...
    url: "https://leetcode.com/u/amrutkarsoham22/",
    color: "#FFA116",
    gradient: "from-[#000000] via-[#FFA116] to-[#828282]"
  },
  {
    name: "Mail",
    displayName: "Gmail",
    subText: "amrutkarsoham22@gmail.com",
    icon: Mail,
    url: "https://mail.google.com/mail/u/0/?to=amrutkarsoham22@gmail.com&fs=1&tf=cm",
    color: "#c03535ff",
    gradient: "from-[#D93025] to-[#B12704]",
  },
  {
    name: "Phone",
    displayName: "Phone",
    subText: "+91 9172929685",
    icon: Phone,
    url: "tel:+919172929685",
    color: "#269b61ff",
...
const SocialLinks = () => {
  ...
  const [linkedin,github,codeforces,leetcode,mail,phone] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[codeforces,leetcode].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
